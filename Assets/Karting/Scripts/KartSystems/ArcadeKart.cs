...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        /// <summary>
        /// Funcion de administracion de inputs
        /// </summary>
        void GatherInputs()
        {
            // reset input
...
#if UNITY_ANDROID
            //Si es Android se usan los controles TOUCH
            var inputSource = m_Inputs[1];
#else
            //Si es Windows se usa el teclado
            var inputSource = m_Inputs[0];
#endif
