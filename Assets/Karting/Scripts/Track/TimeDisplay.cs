...
namespace KartGame.Track
{
    ...
    public class TimeDisplay : MonoBehaviour
    {
        ...
        [Tooltip("New Record that pops up when a new record is beaten.")]
        public Transform newRecordPopUp;
        ...
        private float bestCurrentTime;

        void Awake()
        {
            bestCurrentTime = PlayerPrefs.GetFloat("BestTime", -1);
        ...
        private void Start()
        {
            newRecordPopUp.gameObject.SetActive(false);
        }
        ...
        /// <summary>
        /// Funcion que muestra un letrero de nuevo record
        /// </summary>
        System.Collections.IEnumerator ShowNewRecordPopUp()
        {
            newRecordPopUp.gameObject.SetActive(true);
        ...
        /// <summary>
        /// Retorna en string formateada el tiempo de vuelta
        /// </summary>
        /// <param name="time">time en float</param>
        /// <returns>time en string</returns>
        ...
        public float GetSessionBestLapTime()
        {
            int bestLap = getBestLap();

            if (bestLap < 0) return -1;

            return finishedLapTimes[bestLap];
        }
    }
}
